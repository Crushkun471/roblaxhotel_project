...
class AdminController extends Controller
{
    ...
    public function create_staff(Request $request)
    {
        ...
        \App\Models\User::create([
            ...
            'usertype' => $request->usertype, // either 'staff' or 'admin'
            'role' => $request->role,         // e.g., receptionist
        ]);
    ...
    {
        $data = \App\Models\User::whereIn('usertype', ['staff', 'admin'])->get();
    ...
    public function edit_staff(Request $request, $id)
    {
        ...
        $staff = \App\Models\User::findOrFail($id);
        $staff->update($request->only('name', 'email', 'phone', 'role', 'usertype'));
